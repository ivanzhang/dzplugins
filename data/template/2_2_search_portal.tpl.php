...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1363523837, '2', './data/template/2_2_search_portal.tpl.php', './template/dfsj_aadagaioo', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1363523837, '2', './data/template/2_2_search_portal.tpl.php', './template/dfsj_aadagaioo', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1363523837, '2', './data/template/2_2_search_portal.tpl.php', './template/dfsj_aadagaioo', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1363523837, '2', './data/template/2_2_search_portal.tpl.php', './template/dfsj_aadagaioo', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363523837, '2', './data/template/2_2_search_portal.tpl.php', './template/dfsj_aadagaioo', 'search/portal')
;?>
...
<?php if(empty($_GET['diy'])) { ?><?php $_GET['diy'] = '';?><?php } if(!isset($topic)) { ?><?php $topic = array();?><?php } ?></head>
