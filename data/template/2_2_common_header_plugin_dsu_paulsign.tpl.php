...
0
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363523816, '2', './data/template/2_2_common_header_plugin_dsu_paulsign.tpl.php', './template/dfsj_aadagaioo', 'common/header_plugin_dsu_paulsign')
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1363523816, '2', './data/template/2_2_common_header_plugin_dsu_paulsign.tpl.php', './template/dfsj_aadagaioo', 'common/header_plugin_dsu_paulsign')
;?>
