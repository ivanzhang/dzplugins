...
0
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363525039, '2', './data/template/2_2_common_header.tpl.php', './template/dfsj_aadagaioo', 'common/header')
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1363525039, '2', './data/template/2_2_common_header.tpl.php', './template/dfsj_aadagaioo', 'common/header')
;?>
