...
0
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363525116, '2', './data/template/2_2_common_header_connect_login.tpl.php', './template/dfsj_aadagaioo', 'common/header_connect_login')
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1363525116, '2', './data/template/2_2_common_header_connect_login.tpl.php', './template/dfsj_aadagaioo', 'common/header_connect_login')
;?>
