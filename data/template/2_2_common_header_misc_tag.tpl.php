...
0
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363539389, '2', './data/template/2_2_common_header_misc_tag.tpl.php', './template/dfsj_aadagaioo', 'common/header_misc_tag')
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1363539389, '2', './data/template/2_2_common_header_misc_tag.tpl.php', './template/dfsj_aadagaioo', 'common/header_misc_tag')
;?>
