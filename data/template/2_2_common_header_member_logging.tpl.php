...
0
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363516648, '2', './data/template/2_2_common_header_member_logging.tpl.php', './template/dfsj_aadagaioo', 'common/header_member_logging')
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1363516648, '2', './data/template/2_2_common_header_member_logging.tpl.php', './template/dfsj_aadagaioo', 'common/header_member_logging')
;?>
