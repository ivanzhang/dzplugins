...
<div class="pbm cl">
<div class="sch">搜索: <input type="text" class="px vm" onkeyup="forumlistsearch(this.value)" /></div>
<h2><?php if($visitedforums || $favforums) { ?>版块列表<?php } else { ?>&nbsp;<?php } ?></h2>
</div>
