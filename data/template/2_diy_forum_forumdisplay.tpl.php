...
0
|| checktplrefresh('./template/dfsj_aadagaioo/forum/forumdisplay.htm', './template/dfsj_aadagaioo/common/header.htm', 1363515990, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/dfsj_aadagaioo', 'forum/forumdisplay')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1363515990, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/dfsj_aadagaioo', 'forum/forumdisplay')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1363515990, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/dfsj_aadagaioo', 'forum/forumdisplay')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/forumdisplay.htm', './template/dfsj_aadagaioo/forum/forumdisplay_list.htm', 1363515990, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/dfsj_aadagaioo', 'forum/forumdisplay')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1363515990, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/dfsj_aadagaioo', 'forum/forumdisplay')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/forumdisplay.htm', './template/dfsj_aadagaioo/common/footer.htm', 1363515990, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/dfsj_aadagaioo', 'forum/forumdisplay')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/forumdisplay.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363515990, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/dfsj_aadagaioo', 'forum/forumdisplay')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/forumdisplay.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1363515990, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/dfsj_aadagaioo', 'forum/forumdisplay')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1363515990, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/dfsj_aadagaioo', 'forum/forumdisplay')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1363515990, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/dfsj_aadagaioo', 'forum/forumdisplay')
;?>
...
今日&nbsp;<span><?php echo $todayposts;?></span>－昨日&nbsp;<span><?php echo $postdata['0'];?></span>－帖子&nbsp;<span><?php echo $posts;?></span>－会员&nbsp;<span><?php echo $_G['cache']['userstats']['totalmembers'];?></span><?php if($_G['cache']['userstats']['newsetuser']) { ?>－欢迎新会员&nbsp;<span><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['cache']['userstats']['newsetuser']); ?>" target="_blank" class="xi2"><?php echo $_G['cache']['userstats']['newsetuser'];?></a></span><?php } } else { ?><?php $dfsj_users = DB::result_first("SELECT count(*) FROM ".DB::table('common_member'));$onlinenum = DB::result_first("SELECT count(*) FROM ".DB::table('common_session'));$todaypost = DB::result_first("SELECT sum(todayposts) FROM ".DB::table('forum_forum')." WHERE status=1");?>今日&nbsp;<span><?php echo $todaypost;?></span>－会员&nbsp;<span><?php echo $dfsj_users;?></span>－在线&nbsp;<span><?php echo $onlinenum;?></span>
<?php } ?>
</div>
</div>
...
<tbody>
<tr>
<td class="icn"><img src="<?php echo $_G['style']['styleimgdir'];?>/ann_icon.gif" alt="公告" /></td>
...
<tbody id="<?php echo $thread['id'];?>" class="<?php echo swapclass('alt'); ?>">
<tr>
<td class="icn">
