...
0
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363941392, '2', './data/template/2_2_common_header_home_follow.tpl.php', './template/dfsj_aadagaioo', 'common/header_home_follow')
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1363941392, '2', './data/template/2_2_common_header_home_follow.tpl.php', './template/dfsj_aadagaioo', 'common/header_home_follow')
;?>
