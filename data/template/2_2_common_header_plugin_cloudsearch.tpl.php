...
0
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363523839, '2', './data/template/2_2_common_header_plugin_cloudsearch.tpl.php', './template/dfsj_aadagaioo', 'common/header_plugin_cloudsearch')
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1363523839, '2', './data/template/2_2_common_header_plugin_cloudsearch.tpl.php', './template/dfsj_aadagaioo', 'common/header_plugin_cloudsearch')
;?>
