...
0
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1364376080, '2', './data/template/2_2_common_header_search_blog.tpl.php', './template/dfsj_aadagaioo', 'common/header_search_blog')
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1364376080, '2', './data/template/2_2_common_header_search_blog.tpl.php', './template/dfsj_aadagaioo', 'common/header_search_blog')
;?>
