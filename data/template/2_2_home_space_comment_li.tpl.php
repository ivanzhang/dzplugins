...
<?php if(!empty($_G['setting']['pluginhooks']['space_blog_comment_op'][$k])) echo $_G['setting']['pluginhooks']['space_blog_comment_op'][$k];?>
...
<?php if(!empty($_G['setting']['pluginhooks']['space_blog_comment_bottom'])) echo $_G['setting']['pluginhooks']['space_blog_comment_bottom'];?>
