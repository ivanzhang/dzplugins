...
0
|| checktplrefresh('./template/dfsj_aadagaioo/forum/viewthread.htm', './template/dfsj_aadagaioo/common/header.htm', 1363516197, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_aadagaioo', 'forum/viewthread')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/viewthread.htm', './template/dfsj_aadagaioo/forum/viewthread_node.htm', 1363516197, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_aadagaioo', 'forum/viewthread')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1363516197, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_aadagaioo', 'forum/viewthread')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/viewthread.htm', './template/dfsj_aadagaioo/common/footer.htm', 1363516197, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_aadagaioo', 'forum/viewthread')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/viewthread.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363516197, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_aadagaioo', 'forum/viewthread')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/viewthread.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1363516197, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_aadagaioo', 'forum/viewthread')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1363516197, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_aadagaioo', 'forum/viewthread')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/viewthread.htm', './template/default/common/seditor.htm', 1363516197, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_aadagaioo', 'forum/viewthread')
|| checktplrefresh('./template/dfsj_aadagaioo/forum/viewthread.htm', './template/default/common/seccheck.htm', 1363516197, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_aadagaioo', 'forum/viewthread')
;?>
...
<span class="dfsj_post_b"><span></span></span>
    </div><?php $postcount = 0;?><?php if(is_array($postlist)) foreach($postlist as $post) { if($rushreply && $_GET['checkrush'] && $post['rewardfloor'] != 1) { ?><?php continue;?><?php } ?>
...
<div class="dfsj_postx <?php echo swapclass('dfsj_post'); ?>">
<span class="dfsj_post_t"><span></span></span>
