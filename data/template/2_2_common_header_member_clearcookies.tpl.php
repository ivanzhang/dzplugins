...
0
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363523848, '2', './data/template/2_2_common_header_member_clearcookies.tpl.php', './template/dfsj_aadagaioo', 'common/header_member_clearcookies')
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1363523848, '2', './data/template/2_2_common_header_member_clearcookies.tpl.php', './template/dfsj_aadagaioo', 'common/header_member_clearcookies')
;?>
