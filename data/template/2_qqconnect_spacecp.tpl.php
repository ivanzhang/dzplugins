...
<?php if($_GET['pluginop'] == 'share') { include template('common/header'); if($_GET['sh_type'] == 1 || $_GET['sh_type'] == 3) { ?>
<h3 class="flb">
<?php if($_GET['sh_type'] == 1) { ?>
<em id="return_<?php echo $_GET['handlekey'];?>">分享到QQ空间和腾讯朋友</em>
<?php } elseif($_GET['sh_type'] == 3) { ?>
<em id="return_<?php echo $_GET['handlekey'];?>">分享到腾讯朋友和QQ空间</em>
<?php } if($_G['inajax']) { ?>
...
<th>绑定设置</th>
<td>
<label for="ispublishfeed"><input type="checkbox" id="ispublishfeed" name="ispublishfeed" class="pc" value="1" <?php if($_G['member']['conispublishfeed']) { ?>checked="checked"<?php } ?> /> 发表主题时默认发送动态到QQ空间</label>
</td>
</tr>
<tr>
<th></th>
...
<dt>发表主题同时推送到QQ空间和腾讯微博</dt>
<dd class="xg1">将您的论坛主题推送到QQ空间和腾讯微博，让好友全方面了解您</dd>
