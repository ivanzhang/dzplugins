...
0
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1364139509, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/dfsj_aadagaioo', 'common/header_home_task')
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1364139509, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/dfsj_aadagaioo', 'common/header_home_task')
;?>
