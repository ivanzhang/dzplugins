...
0
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1363522791, '2', './data/template/2_2_common_header_home_misc.tpl.php', './template/dfsj_aadagaioo', 'common/header_home_misc')
|| checktplrefresh('./template/dfsj_aadagaioo/common/header.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1363522791, '2', './data/template/2_2_common_header_home_misc.tpl.php', './template/dfsj_aadagaioo', 'common/header_home_misc')
;?>
