...
0
|| checktplrefresh('./template/default/group/index.htm', './template/dfsj_aadagaioo/common/header.htm', 1364048346, 'diy', './data/template/2_diy_group_index.tpl.php', './template/dfsj_aadagaioo', 'group/index')
|| checktplrefresh('./template/default/group/index.htm', './template/dfsj_aadagaioo/common/footer.htm', 1364048346, 'diy', './data/template/2_diy_group_index.tpl.php', './template/dfsj_aadagaioo', 'group/index')
|| checktplrefresh('./template/default/group/index.htm', './template/dfsj_aadagaioo/common/header_common.htm', 1364048346, 'diy', './data/template/2_diy_group_index.tpl.php', './template/dfsj_aadagaioo', 'group/index')
|| checktplrefresh('./template/default/group/index.htm', './template/dfsj_aadagaioo/common/pubsearchform.htm', 1364048346, 'diy', './data/template/2_diy_group_index.tpl.php', './template/dfsj_aadagaioo', 'group/index')
;?>
