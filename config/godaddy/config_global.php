...
$_config['db']['1']['dbhost'] = 'yhgdb.db.10510646.hostedresource.com';

$_config['db']['1']['dbuser'] = 'yhgdb';

$_config['db']['1']['dbpw'] = 'zaq1XSW@';

$_config['db']['1']['dbcharset'] = 'utf8';

$_config['db']['1']['pconnect'] = '0';

$_config['db']['1']['dbname'] = 'yhgdb';

$_config['db']['1']['tablepre'] = 'bbs';
...
$_config['cookie']['cookiepre'] = '8Fdw_';

$_config['cookie']['cookiedomain'] = 'yihuagong.net';
...
$_config['security']['authkey'] = '7d1dd4OedyWZd0i3';
